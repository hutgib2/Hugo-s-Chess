...
from game.pieces.dragon import Dragon
from game.pieces.archer import Archer
from game.pieces.wizard import Wizard
from game.pieces.catapult import Catapult
